...
public class ZipUtils {
	 ...
	 * @return 添加压缩包中的文件列表
	 */
	@Contract(pure = true) public List<String> compress(byte[] bytes, @NotNull String entryName) {
	 ...
	 * @return 添加压缩包中的文件列表
	 */
	@Contract(pure = true) public List<String> addByte(byte[] bytes, @NotNull String entryName) {
